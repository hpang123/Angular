...
/*
 * feature module must be self-contained and include all the information that Angular requires,
 * including the routing URLs that are supported and the components they display.
