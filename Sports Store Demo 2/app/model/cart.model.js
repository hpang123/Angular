...
/*
 * @Injectable makes the Cart a service, which means that Angular will take responsibility
 * for creating an instance of the Cart class
 * and will use it when it needs to create a component that has a Cart constructor argument.
 * This is another use of the Angular dependency injection feature,
 * which can be used to share objects throughout an application
 */
var Cart = (function () {
    function Cart() {
        this.lines = [];
